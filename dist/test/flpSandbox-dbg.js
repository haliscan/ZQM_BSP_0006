		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Uygunsuzluk Görev Ekranı",
									"targetURL": "#comkarsanqmtaskmanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkarsanqmtaskmanage-display": {
								"semanticObject": "comkarsanqmtaskmanage",
								"action": "display",
								"description": "Uygunsuzluk Görev Ekranı",
								"title": "Uygunsuzluk Görev Ekranı",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.karsan.qm.taskmanage",
									"url": sap.ui.require.toUrl("com/karsan/qm/taskmanage")
								}
							}
						}
					}
